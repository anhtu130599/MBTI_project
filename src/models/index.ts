...
export { default as TestResult } from '@/core/infrastructure/database/models/TestResult';
export { default as Career } from '@/core/infrastructure/database/models/Career';
export { default as PersonalityType } from '@/core/infrastructure/database/models/PersonalityType'; 
